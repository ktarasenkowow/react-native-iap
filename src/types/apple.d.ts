export declare enum ReceiptValidationStatus {
...
export declare enum SubscriptionExpirationIntent {
...
export declare enum SubscriptionRetryFlag {
...
export declare enum SubscriptionAutoRenewStatus {
...
export declare enum SubscriptionPriceConsentStatus {
